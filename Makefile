...
# Process RCVS-2021 data
data/rcvs2021_crimecost_processed.rdata: data/rcvs2021_crimecost.rdata data/rcvs2021_raking_fit.rdata
	$(RUN) code/2_prepare_data.r
...
tables/ols_lnlifesatisfaction_victimization.tex: data/rcvs2021_crimecost_processed.rdata
	$(RUN) code/3_estimate_regression_models.r
tables/ols_lnlifesatisfaction_victimization_raking.tex: data/rcvs2021_crimecost_processed.rdata
	$(RUN) code/3_estimate_regression_models.r
tables/ols_lnlifesatisfaction_income.tex: data/rcvs2021_crimecost_processed.rdata
	$(RUN) code/3_estimate_regression_models.r
tables/ols_lnlifesatisfaction_income_raking.tex: data/rcvs2021_crimecost_processed.rdata
	$(RUN) code/3_estimate_regression_models.r
tables/ols_lnlifesatisfaction_fear.tex: data/rcvs2021_crimecost_processed.rdata
	$(RUN) code/3_estimate_regression_models.r
tables/ols_lnlifesatisfaction_fear_raking.tex: data/rcvs2021_crimecost_processed.rdata
	$(RUN) code/3_estimate_regression_models.r
tables/ols_lnlifesatisfaction_crimetype.tex: data/rcvs2021_crimecost_processed.rdata
	$(RUN) code/3_estimate_regression_models.r
tables/ols_lnlifesatisfaction_crimetype_raking.tex: data/rcvs2021_crimecost_processed.rdata
	$(RUN) code/3_estimate_regression_models.r
tables/costofcrime_estimates_table_yearly.tex: data/rcvs2021_crimecost_processed.rdata
	$(RUN) code/3_estimate_regression_models.r
estimates/costofcrime_estimates_19aug21.csv: data/rcvs2021_crimecost_processed.rdata
	$(RUN) code/3_estimate_regression_models.r

# Plot income derivative
media/lifesatisfaction_income_deriv_plot.pdf: data/rcvs2021_crimecost_processed.rdata
	$(RUN) code/3_estimate_regression_models.r
media/lifesatisfaction_income_deriv_plot_en.pdf: data/rcvs2021_crimecost_processed.rdata
	$(RUN) code/3_estimate_regression_models.r

# Perform multiple imputation
data/rcvs2021_crimecost_imputed.rdata: data/rcvs2021_crimecost_processed.rdata
	$(RUN) code/4_multiple_imputation_regressions.r

# Plot income densities after imputation
media/density_mean_income_actual_imputed.pdf: data/rcvs2021_crimecost_processed.rdata
	$(RUN) code/4_multiple_imputation_regressions.r
media/density_mean_income_actual_imputed_en.pdf: data/rcvs2021_crimecost_processed.rdata
	$(RUN) code/4_multiple_imputation_regressions.r

# Create a chart with official crime statistics and estimates
media/official_crime_costs.pdf: data/rcvs2021_crimecost.rdata
	$(RUN) code/5_extract_official_crime_counts.r
...
data: data/kouzh_2020_data.rdata \
	  ...
	  data/rcvs2021_crimecost_processed.rdata \
